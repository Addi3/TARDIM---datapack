...
execute if score tick coral matches 200 at @e[tag=growing_coral] run playsound minecraft:block.shroomlight.break ambient @p[distance=..5] ~ ~ ~ 1 1 1
...
execute if score tick coral matches 700 at @e[tag=growing_coral] run playsound minecraft:block.shroomlight.break ambient @p[distance=..5] ~ ~ ~ 1 1 1
...
execute if score tick coral matches 1200 at @e[tag=growing_coral] run playsound minecraft:block.shroomlight.break ambient @p[distance=..5] ~ ~ ~ 1 1 1
...
execute if score tick coral matches 1500 at @e[tag=growing_coral] run playsound minecraft:block.shroomlight.break ambient @p[distance=..5] ~ ~ ~ 1 1 1
...
execute if score tick coral matches 2000 at @e[tag=growing_coral] run playsound minecraft:block.shroomlight.break ambient @p[distance=..5] ~ ~ ~ 1 1 1
...
execute if score tick coral matches 2050 at @e[tag=growing_coral] run playsound minecraft:block.shroomlight.break ambient @p[distance=..5] ~ ~ ~ 1 1 1
