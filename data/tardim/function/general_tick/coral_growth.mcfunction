...
execute if score tick coral matches 2052 run tag @e[tag=growing_coral] remove growing_coral
execute if score tick coral matches 2053 run scoreboard players reset tick coral
