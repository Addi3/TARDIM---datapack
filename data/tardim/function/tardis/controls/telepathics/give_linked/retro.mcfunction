clear @p minecraft:iron_nugget[minecraft:custom_model_data=2]
give @p iron_nugget[custom_model_data=2,lore=['"Linked: Tardis1"'],custom_name='{"color":"gold","text":"Retro Key"}'] 1
