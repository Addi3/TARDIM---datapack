clear @p minecraft:iron_nugget[minecraft:custom_model_data=1]
give @p iron_nugget[custom_model_data=1,lore=['"Linked: Tardis1"'],custom_name='{"color":"gold","text":"Classic Key"}'] 1
