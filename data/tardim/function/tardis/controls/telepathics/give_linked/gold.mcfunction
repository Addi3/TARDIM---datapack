clear @p minecraft:iron_nugget[minecraft:custom_model_data=4]
give @p iron_nugget[custom_model_data=4,lore=['"Linked: Tardis1"'],custom_name='{"color":"gold","text":"Gold Key"}'] 1
